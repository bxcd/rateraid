...
public class ColorDetailActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ColorDetailFragment.ARG_ITEM_ID,
            getIntent().getStringExtra(ColorDetailFragment.ARG_ITEM_ID));
            ColorDetailFragment fragment = new ColorDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.color_detail_container, fragment)
                    .commit();
        }
    }
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, ColorListActivity.class));
            return true;
        }
